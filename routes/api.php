...
// Higher limit to accommodate polling (max 12 requests per minute with 5s intervals)
Route::get('/gcb/verify', [\App\Http\Controllers\Api\GcbPaymentController::class, 'verify'])->middleware(['auth:sanctum', 'throttle:120,1']);
